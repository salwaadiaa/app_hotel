            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('booking.store') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn btn-block" style="background-color: #e91e63;">Submit Booking</button>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    ...
    if (bookingSuccess === 'true') {
        swal("Terima kasih sudah melakukan pemesanan di hotel kami!", {
            buttons: false,
            timer: 3000, 
        });
    }
