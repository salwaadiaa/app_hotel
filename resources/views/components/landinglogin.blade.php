                        ...
                        <div class="nav-menu">
                            <nav class="mainmenu">
                                <ul>
                                   ...
                                   <li class="getstarted">
    @if(Auth::check())
        <a class="scrollto" href="#">{{ Auth::user()->name }}</a>
        <span class="separator">|</span>
        <a class="scrollto" href="{{ route('logout') }}">Logout</a>
    @else
        ...
        <div class="hp-room-items">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="hp-room-item set-bg" data-setbg="{{ asset('images/kategori/' . $category->gambar) }}">
                        <div class="hr-text">
                            <h3>{{ $category->name }}</h3>
                            <h2></span></h2>
                            <table>
